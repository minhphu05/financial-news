...
``company_name_en``, ``Keywords``) into the PostgreSQL ``stock`` and ``keyword``
tables, and registers the known news ``source`` rows. Idempotent — safe to run
...
_SOURCES = [
    {"name": "cafef", "base_url": "https://cafef.vn", "country": "VN", "language": "vi"},
    {"name": "vnexpress", "base_url": "https://vnexpress.net", "country": "VN", "language": "vi"},
    {"name": "baomoi", "base_url": "https://baomoi.com", "country": "VN", "language": "vi"},
    {"name": "thanhnien", "base_url": "https://thanhnien.vn", "country": "VN", "language": "vi"},
    {"name": "tuoitre", "base_url": "https://tuoitre.vn", "country": "VN", "language": "vi"},
]
...
def seed(xlsx_path: Path) -> None:
    ...
    with session_factory() as session:
        ...
        for _, row in df.iterrows():
            ...
            keywords = row[_KEYWORDS_COLUMN]
            if not ticker:
                continue

            stmt = (
                pg_insert(Stock)
                .values(ticker=ticker, company_name=company)
